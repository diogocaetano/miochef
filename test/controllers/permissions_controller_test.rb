...
class PermissionsControllerTest < ActionController::TestCase
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post :create, permission: { action_name: @permission.action_name, entity_id: @permission.entity_id, route: @permission.route }
    end
  ...
  test "should update permission" do
    patch :update, id: @permission, permission: { action_name: @permission.action_name, entity_id: @permission.entity_id, route: @permission.route }
    assert_redirected_to permission_path(assigns(:permission))
  end
